    ...
    <>
      ...
      <div className="calculator-form-wrapper">
        <div class="flex w-full items-center gap-4">
          <button className="flex gap-2 items-center" onClick={() => props.updateDisplay(false)}><ChevronLeftIcon className="h-5 w-5 color-[#636363]" aria-hidden="true"/><span className="text-[#636363] text-[14px] leading-[14px]">Calculators</span></button>
          <button
