...
import CalculatorsWrapper from "./Calculator";
import { Gear, Logo } from "../assets/Icons";
  ...
  return (
    <div className="antialiased">
      ...
      >
        ...
        <div className="hidden absolute bottom-0 left-0 justify-center p-4 space-x-4 w-full lg:flex bg-white dark:bg-indigo-800 z-20">
          <a
            href="#"
